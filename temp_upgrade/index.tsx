    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-black/80 backdrop-blur-xl border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10 text-[13px] font-bold uppercase tracking-widest text-gray-400">
          ...
          <button onClick={() => window.location.href='/app'} className="px-6 py-2.5 bg-white text-black rounded-full hover:bg-indigo-500 hover:text-white transition-all duration-300 font-bold">
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-6 items-center">
              ...
              <button onClick={() => window.location.href='/app'} className="w-full max-w-xs py-4 bg-white text-black rounded-full font-black uppercase tracking-widest">Launch Dashboard</button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
    ...
    <section className="relative min-h-screen pt-44 pb-24 overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-3 px-6 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-10"
        >
        ...
        <motion.h1 
          ...
          className="text-6xl md:text-9xl font-black text-white leading-[0.95] mb-10 tracking-tighter"
        >
          AUTOMATE <br />
        ...
        >
          <button className="group relative px-10 py-5 bg-white text-black rounded-full font-black uppercase tracking-widest text-sm transition-all hover:scale-105 active:scale-95 shadow-[0_20px_40px_-15px_rgba(255,255,255,0.2)]">
            Start Free Trial
            <ArrowRight className="inline-block ml-3 w-5 h-5 group-hover:translate-x-2 transition-transform" />
          </button>
          <button className="px-10 py-5 bg-white/5 border border-white/10 text-white rounded-full font-black uppercase tracking-widest text-sm backdrop-blur-sm transition-all hover:bg-white/10">
            Book Demo
          </button>
        </motion.div>
